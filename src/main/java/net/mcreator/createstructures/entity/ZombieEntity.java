...
public class ZombieEntity extends Monster {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("create_structures:scorched"));
	...
	public ZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CreateStructuresModEntities.ZOMBIE.get(), world);
	}
